...
const Office = () => {
  ...
  useEffect(() => {
    axiosClient.get("/explore/undefined").then(({ data }) => {
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-7xl sm:px-6 sm:py-24 lg:px-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <a href="/" className="font-extrabold text-2xl hover:underline mt-5">
              Offres populaires
            </a>
            <svg
              width="25"
      ...
      <div className="ml-7">
        <h1 className="font-extrabold text-2xl hover:underline flex items-center">
        ...
        <div className="mt-4">{/* Add content here */}</div>
      </div>
    </div>
  );
};
