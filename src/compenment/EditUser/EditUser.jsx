...
function Register() {
  ...
  const handleTypeCompteChange = (value) => {
      setTypeCompte(value);
  };
  ...
  const handleEmailChange = (e) => {
    ...
    useEffect(() => {
		axiosClient.get('/user').then(({ data }) => {
			...
			setNom(data.nom);
			setTypeCompte(data.type_compte);
	...
	try {
        ...
        const response = await axiosClient.put('/user', values);
				...
				<div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2 mt-10">
					...
					<div>
						...
						<div className="mt-2.5">
							<Input id="prenom" name="prenom" value={prenom} onInput={handlePrenomChange} required/>
						</div>
					</div>
					<div>
						...
						<div className="mt-2.5">
							<Input id="nom" name="nom" value={nom} onInput={handleNomChange} required/>
						</div>
					</div>
					<div>
						...
						<div className="mt-2.5">
							<RadioGroup id="type_compte" name="type_compte" onValueChange={handleTypeCompteChange} defaultValue={type_compte} value={type_compte} required>
								...
								<div className="flex items-center space-x-2">
									<RadioGroupItem value="Tourist" id="r3"/>
					...
					<div className="sm:col-span-2">
						...
						<div className="mt-2.5">
							<Select name="languages" onValueChange={handleLanguagesChange} value={languages} required>
					...
					<div className="sm:col-span-2">
						...
						<div className="mt-2.5">
							<Select name="nationalite" onValueChange={handleNationaliteChange} value={nationalite} required>
					...
					<div className="sm:col-span-2">
						<label htmlFor="patente" className="block text-sm font-semibold leading-6 text-gray-900">
							Patente
						</label>
						<div className="mt-2.5">
							<Input id="patente" name="patente" value={patente} onInput={handlePatenteChange} required/>
						</div>
					</div>
					<div className="sm:col-span-2">
						...
						<div className="mt-2.5">
							<Input id="email" name="email" value={email} onInput={handleEmailChange} required/>
						</div>
					</div>
					<div className="sm:col-span-2">
						<label htmlFor="old_password" className="block text-sm font-semibold leading-6 text-gray-900">
							Mot de passe Actuel
						</label>
						<div className="mt-2.5">
